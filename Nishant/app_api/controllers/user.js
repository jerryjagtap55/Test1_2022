...
exports.registerUser = async ( req, res, next ) => {
  try {
    ...
    jwt.sign( payload, "https://jwt.io/#debugger-io?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.cThIIoDvwdueQB468K5xDc5633seEFoqwxjF_xSJyQQ", { expiresIn: 3600 }, ( err, token ) => {
      if ( err ) {
        throw err;
      }
